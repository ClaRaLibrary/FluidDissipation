...
algorithm
  ...
  annotation (
    ...
    inverse(dp=FluidDissipation.PressureLoss.StraightPipe.dp_laminar_DP(
          IN_con,
          IN_var,
          M_FLOW)),
...
<p> 
<img src=\"modelica://FluidDissipation/Extras/Images/pressureLoss/straightPipe/fig_straightPipe_dp_laminar_MFLOWvsDP.png\">
</p>
