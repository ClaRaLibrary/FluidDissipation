...
function dp_Tzero "zero mass flow rate through general T-junction"
  ...
  //input records
  input FluidDissipation.PressureLoss.Junction.dp_Tjoin_IN_con IN_con "input record for function dp_Tjunction"
    annotation (Placement(transformation(extent={{-100,12},{-80,32}})));
  input FluidDissipation.PressureLoss.Junction.dp_Tjoin_IN_var IN_var "input record for function dp_Tjunction"
