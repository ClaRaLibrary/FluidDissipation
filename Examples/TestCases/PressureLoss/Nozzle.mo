...
model Nozzle "Test cases of pressure loss functions for nozzles"
...
public
  ...
  Applications.PressureLoss.NozzleFlowModel from_mflow(
        ...
        A_2=PI*0.05^2/4,
        C_1=PI*0.1,
        C_2=PI*0.05)) "Calculate pressure loss from mass flow rate"
...
<p>
Switch to the diagram or equation layer to see the model of a <b> Modelica.Fluid nozzle </b> using <b> FluidDissipation pressure loss calculations </b>.
</p>
</html>
"), experiment(Interval=0.0002),
    Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{100,
          ...
          extent={{-92,100},{90,38}},
          lineColor={0,0,255},
          textString="Test: Nozzle functions"),   Text(
          extent={{-56,40},{60,24}},
          lineColor={255,0,0},
          textString=
