...
model HeatExchanger "Test cases of generic pressure loss functions"
...
<p>
Switch to the diagram or equation layer to see the model of a <b> Modelica.Fluid heat exchanger </b> using <b> FluidDissipation pressure loss calculations </b>.
</p>
</html>
"), experiment(Interval=0.0002),
    Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{100,
          ...
          extent={{-96,120},{86,58}},
          lineColor={0,0,255},
          textString="Test: Heat exchanger functions"), Text(
          extent={{-56,-2},{60,-18}},
          lineColor={255,0,0},
          textString=
