...
model Valve "Test cases of pressure loss functions for valves"
...
public
  ...
  Applications.PressureLoss.ValveFlowModel from_mflow(redeclare package Medium
      ...
      FlowModel =
        ...
        dp_nominal=200000,
        m_flow_nominal=1,
        opening_nominal=1)) "Calculate pressure loss from mass flow rate"
...
<p>
Switch to the diagram or equation layer to see the model of a <b> Modelica.Fluid valve </b> using <b> FluidDissipation pressure loss calculations </b>.
</p>
</html>
"), experiment(Interval=0.0002),
    Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{100,
            100}}), graphics={Text(
          extent={{-102,88},{104,64}},
          lineColor={0,0,255},
          textString="Test: Valve functions"),Text(
          extent={{-76,-6},{84,-14}},
          lineColor={255,0,0},
          textString=
