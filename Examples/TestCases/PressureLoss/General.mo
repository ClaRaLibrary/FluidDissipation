...
model General "Test cases of generic pressure loss functions"
  ...
  inner Modelica.Fluid.System system(
    ...
    m_flow_small=0.01,
    dp_small(displayUnit="Pa") = 0) annotation (Placement(transformation(extent={{80, -100}, {100, -80}})));
...
<p>
Switch to the diagram or equation layer to see the model of a <b> Modelica.Fluid generic geometry </b> using <b> FluidDissipation pressure loss calculations </b>.
</p>
</html>
