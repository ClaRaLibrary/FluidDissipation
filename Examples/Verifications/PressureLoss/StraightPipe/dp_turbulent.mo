...
model dp_turbulent "Verification of function dp_turbulent"
  ...
  SI.Diameter d_hyd=0.1 "Hydraulic diameter"
    annotation (Dialog(group="Straight pipe"));
  SI.Length K[4]={2e-5*d_hyd,2e-4*d_hyd,2e-3*d_hyd,2e-2*d_hyd}
...
equation
  ...
  annotation (__Dymola_Commands(file=
          "modelica://FluidDissipation/Extras/Scripts/pressureLoss/straightPipe/dp_turbulent.mos"
        "Verification of dp_turbulent"), Diagram(coordinateSystem(
