...
model dp_overall "Verification of function dp_overall"
...
equation
  for i in 1:n loop
    (,M_FLOW[i],,,,) = FluidDissipation.PressureLoss.StraightPipe.dp_overall(
      dp_IN_con[i],
      dp_IN_var[i],
  ...
  for i in 1:n loop
    (DP[i],,,,,) = FluidDissipation.PressureLoss.StraightPipe.dp_overall(
      m_flow_IN_con[i],
      m_flow_IN_var[i],
      chosenTarget_DP[i]);
  end for;
  ...
  annotation (__Dymola_Commands(file=
          "modelica://FluidDissipation/Extras/Scripts/pressureLoss/straightPipe/dp_overall.mos" "Verification of dp_overall"),
                                       Diagram(coordinateSystem(
          preserveAspectRatio=true, extent={{-100,-100},{100,100}}), graphics={
          Text(
          extent={{-100,50},{100,75}},
          lineColor={0,0,255},
          textString="Pressure loss of STRAIGHT PIPE for OVERALL flow regime"),
          Text(
          extent={{13,14},{88,4}},
          lineColor={0,0,255},
