...
model dp_Tjoin "verification of function dp_Tjoin"
  ...
  parameter SI.Velocity v_max=343 "restriction for maximum fluid flow velocity"
    annotation (Dialog(group="restriction"));
  parameter TYP.PressureLossCoefficient zeta_TOT_max=10 "restriction for maximum value of pressure loss coefficient"
    annotation (Dialog(group="restriction"));
  ...
  FluidDissipation.PressureLoss.Junction.dp_Tjoin_IN_con m_flow_IN_con_1(
    alpha=alpha[1],
    d_hyd=d_hyd_conv,
  ...
  //incompressible fluid flow (A_side + A_straight > A_total)
  FluidDissipation.PressureLoss.Junction.dp_Tjoin_IN_con m_flow_IN_con_2(
    alpha=alpha[1],
    d_hyd=d_hyd_noconv,
    m_flow_min=m_flow_min,
    v_max=v_max,
...
equation
  //incompressible fluid flow (A_side + A_straight = A_total)
  (DP_plot1,,zeta_LOC1,,) = FluidDissipation.PressureLoss.Junction.dp_Tjoin(
    m_flow_IN_con_1,
    m_flow_IN_var_1,
    m_flow);

  //incompressible fluid flow (A_side + A_straight > A_total)
  (DP_plot2,,zeta_LOC2,,) = FluidDissipation.PressureLoss.Junction.dp_Tjoin(
    m_flow_IN_con_2,
    m_flow_IN_var_2,
    m_flow);

  annotation (__Dymola_Commands(file=
          "modelica://FluidDissipation/Extras/Scripts/pressureLoss/junction/dp_Tjoin.mos" "verification dp_Tjoin"),
        ...
        graphics={Text(
                    ...
                    lineColor={0,0,255},
                    textString=
            "Pressure loss of SMOOTH T-junction for JOINING at TURBULENT flow regime"),
