...
model dp_edgedOverall "Verification of function dp_edgedOverall"
  ...
  Utilities.Types.PressureLossCoefficient zeta_TOT[n], zeta_TOT2[n] "Pressure loss coefficient"
...
equation
  ...
  annotation (__Dymola_Commands(file=
          "modelica://FluidDissipation/Extras/Scripts/pressureLoss/bend/dp_edgedOverall.mos" "Verification of dp_edgedOverall"),
