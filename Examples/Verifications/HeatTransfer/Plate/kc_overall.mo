...
equation
  ...
  for i in 1:n loop
    (,,,Nu[i],) = FluidDissipation.HeatTransfer.Plate.kc_overall(IN_con[i],
      IN_var[i]);
  end for;

  annotation (
    __Dymola_Commands(file="modelica://FluidDissipation/Extras/Scripts/heatTransfer/plate/kc_overall.mos" "Verification of kc_overall"),
