...
equation
  ...
  kc = {FluidDissipation.HeatTransfer.Plate.kc_turbulent_KC(IN_con[i], IN_var[i])
    for i in 1:n};

  annotation (__Dymola_Commands(file=
          "modelica://FluidDissipation/Extras/Scripts/heatTransfer/plate/kc_turbulent_KC.mos" "Verification of kc_turbulent_KC"),
