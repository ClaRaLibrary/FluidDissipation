...
package FilmCondensationTubeBundle "FluidDissipation: Laminar film condensation in a tube bundle"
  ...
  redeclare function extends coefficientOfHeatTransfer
    ...
    input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.HeatExchanger.FilmCondensationTubeBundle.HeatTransferHeatExchanger_con
    IN_con annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
    input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.HeatExchanger.FilmCondensationTubeBundle.HeatTransferHeatExchanger_var
