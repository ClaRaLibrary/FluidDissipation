...
partial model BaseHeatExchangerModelWallState "Base heat transfer model with wall state for heat exchanger functions in Modelica.Fluid"
  ...
  input SI.SpecificHeatCapacityAtConstantPressure cp_w "Specific heat capacity of fluid at constant pressure at wall surface";
  input SI.DynamicViscosity eta_w "Dynamic viscosity of fluid at wall surface";
  input SI.ThermalConductivity lambda_w "Thermal conductivity of fluid at wall surface";
