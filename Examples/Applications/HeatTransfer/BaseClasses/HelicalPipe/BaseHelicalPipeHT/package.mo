...
replaceable partial function coefficientOfHeatTransfer "base function for helical pipes"
  extends Modelica.Icons.Function;

  //input record for helical pipe
  input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.HelicalPipe.BaseHelicalPipeHT.HeatTransferHelicalPipe_con
    IN_con annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.HelicalPipe.BaseHelicalPipeHT.HeatTransferHelicalPipe_var
