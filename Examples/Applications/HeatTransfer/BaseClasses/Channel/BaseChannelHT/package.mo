...
replaceable partial function coefficientOfHeatTransfer "Base function for channel"
  extends Modelica.Icons.Function;

  //Input record for channel
  input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.Channel.BaseChannelHT.HeatTransferChannel_con
    IN_con annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.Channel.BaseChannelHT.HeatTransferChannel_var
