...
replaceable partial function coefficientOfHeatTransfer "base function for straight pipe"

  //input record for straight pipe
  input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.StraightPipe.BaseStraightPipeHT.HeatTransferStraightPipe_con
    IN_con annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.StraightPipe.BaseStraightPipeHT.HeatTransferStraightPipe_var
