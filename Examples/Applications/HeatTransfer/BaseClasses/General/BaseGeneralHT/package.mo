...
replaceable partial function coefficientOfHeatTransfer "Base function for generic geometry"
  extends Modelica.Icons.Function;

  //Input record for channel
  input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.General.BaseGeneralHT.HeatTransferGeneral_con
    IN_con annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.General.BaseGeneralHT.HeatTransferGeneral_var
