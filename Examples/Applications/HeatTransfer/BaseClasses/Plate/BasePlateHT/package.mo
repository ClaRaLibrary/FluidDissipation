...
import FD = FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.Plate.BasePlateHT;


replaceable partial function coefficientOfHeatTransfer "base function for plate"
  extends Modelica.Icons.Function;

  //input record for plates
  input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.Plate.BasePlateHT.HeatTransferPlate_con
    IN_con annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  input FluidDissipation.Examples.Applications.HeatTransfer.BaseClasses.Plate.BasePlateHT.HeatTransferPlate_var
