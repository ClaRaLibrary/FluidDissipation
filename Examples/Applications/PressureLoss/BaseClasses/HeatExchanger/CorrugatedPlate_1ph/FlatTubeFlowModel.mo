...
model FlatTubeFlowModel
  ...
  SI.Length Length(min=1e-2)=0.3
    "length of the heat exchanger plates in flow direction (header center to header center)" annotation (Dialog(group="HeatExchanger"));
  SI.Length Width(min=1e-2)=0.1
