...
model TurbulentFlowModel "Straight pipe (turbulent): Application flow model for straight pipe function in Modelica.Fluid"
...
equation
  m_flow =
    FluidDissipation.Examples.Applications.PressureLoss.BaseClasses.StraightPipe.Turbulent.massFlowRate_dp(
    IN_con,
    IN_var,
    dp);
