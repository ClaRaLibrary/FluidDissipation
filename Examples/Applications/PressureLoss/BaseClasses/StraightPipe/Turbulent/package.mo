...
package Turbulent "FluidDissipation: Turbulent regime of straight pipe"
extends FluidDissipation.Examples.Applications.PressureLoss.BaseClasses.StraightPipe.BaseStraightPipePL;


redeclare function extends massFlowRate_dp

  //input records for straight pipe function
  input FluidDissipation.Examples.Applications.PressureLoss.BaseClasses.StraightPipe.Turbulent.PressureLossInput_con
    IN_con annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  input FluidDissipation.Examples.Applications.PressureLoss.BaseClasses.StraightPipe.Turbulent.PressureLossInput_var
...
<p>
In this package the pressure loss function <a href=\"Modelica://FluidDissipation.PressureLoss.StraightPipe.dp_turbulent\"> dp_turbulent </a> of a straight pipe function with surface roughness dependence out of the <b> FluidDissipation </b> library is  
