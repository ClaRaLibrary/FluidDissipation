...
package Laminar "FluidDissipation: Laminar regime of straight pipe"
...
redeclare function extends massFlowRate_dp
  ...
  input FluidDissipation.Examples.Applications.PressureLoss.BaseClasses.StraightPipe.Laminar.PressureLossInput_con
    IN_con annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  input FluidDissipation.Examples.Applications.PressureLoss.BaseClasses.StraightPipe.Laminar.PressureLossInput_var
...
<p>
In this package the pressure loss function <a href=\"Modelica://FluidDissipation.PressureLoss.StraightPipe.dp_laminar\"> dp_laminar </a> of a straight pipe function with surface roughness dependence out of the <b> FluidDissipation </b> library is  
