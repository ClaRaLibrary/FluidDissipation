...
record PressureLossInput_con "Input record for generic function with pressure loss coefficient dependence"

  extends FluidDissipation.PressureLoss.General.dp_pressureLossCoefficient_IN_con;
