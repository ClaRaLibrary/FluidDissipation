...
package NominalDensityViscosity "FluidDissipation: Generic pressure loss law with density and viscosity dependence"
...
redeclare function extends massFlowRate_dp
  ...
  input FluidDissipation.Examples.Applications.PressureLoss.BaseClasses.General.NominalDensityViscosity.PressureLossInput_con
    IN_con annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  input FluidDissipation.Examples.Applications.PressureLoss.BaseClasses.General.NominalDensityViscosity.PressureLossInput_var
...
<p>
In this package the pressure loss function <a href=\"Modelica://FluidDissipation.PressureLoss.General.dp_nominalDensityViscosity\">  
dp_nominalDensityViscosity </a> of a generic function with volume flow rate dependence out of the <b> FluidDissipation </b> library is  
