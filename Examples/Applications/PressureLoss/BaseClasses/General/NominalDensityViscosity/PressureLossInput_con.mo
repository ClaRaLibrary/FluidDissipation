...
record PressureLossInput_con "Input record for dp_nominalDensityViscosity"

  extends FluidDissipation.PressureLoss.General.dp_nominalDensityViscosity_IN_con;
