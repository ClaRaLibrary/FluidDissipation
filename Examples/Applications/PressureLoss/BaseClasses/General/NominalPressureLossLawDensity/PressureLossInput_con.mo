...
record PressureLossInput_con "Input record for dp_nominalPressureLossLawDensity"

  extends FluidDissipation.PressureLoss.General.dp_nominalPressureLossLawDensity_IN_con;
