...
model NozzleFlowModel "Application flow model for nozzle functions in Modelica.Fluid"
  ...
  replaceable model FlowModel =
    ...
    constrainedby FluidDissipation.Examples.Applications.PressureLoss.BaseClasses.Nozzle.BaseNozzlePL.BaseNozzleModel
