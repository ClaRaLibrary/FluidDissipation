...
function dp_twoPhaseTurbulentMSH_DP "Two phase flow frictional pressure loss for turbulent regime according to Mueller-Steinhagen and Heck (1986)|Calculate pressure loss"
  ...
  input Modelica.SIunits.PressureDifference dp_smooth=0.1 "Pressure difference for linearisation around zero flow"   annotation (Dialog(group="Expert Settings"));
