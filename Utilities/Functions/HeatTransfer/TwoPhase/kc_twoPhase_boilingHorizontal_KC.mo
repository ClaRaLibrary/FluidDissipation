...
function kc_twoPhase_boilingHorizontal_KC
  ...
  //records
  input FluidDissipation.Utilities.Records.HeatTransfer.TwoPhaseFlowHT_IN_con
    IN_con annotation (Dialog(group="Constant inputs"));
  input FluidDissipation.Utilities.Records.HeatTransfer.TwoPhaseFlowHT_IN_var
...
<pre>2016-06-06 Stefan Wischhusen: Removed double code (now just in kc_twoPhase_boilingHorizontal)</pre>
</html>"));
