...
record kc_tubeBundle_1ph_IN_var "Input record for function kc_tubeBundle_1ph and kc_tubeBundle_1ph_KC"
 extends FluidDissipation.Utilities.Records.General.FluidProperties;
  ...
  SI.SpecificHeatCapacityAtConstantPressure cp_w=4.19e3 "Specific heat capacity of fluid near wall at constant pressure"
    annotation (Dialog(group="Fluid properties near wall"));
  SI.DynamicViscosity eta_w=1e-3 "Dynamic viscosity of fluid near wall"
    annotation (Dialog(group="Fluid properties near wall"));
  SI.ThermalConductivity lambda_w=0.58 "Thermal conductivity of fluid  near wall"
    annotation (Dialog(group="Fluid properties near wall"));
